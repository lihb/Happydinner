package com.happydinner.services;
...
import com.happydinner.util.ReflectionHelper;
import com.happydinner.util.SharePreferencesUtils;
import com.happydinner.util.StorageVolumeWrapper;

import java.io.File;

public class DinnerPathManager {

	private static final String TAG = "DinnerPathManager";

	private static DinnerPathManager pathManager = null;
	...
	public static DinnerPathManager get(){
		synchronized (synObject) {
			if(pathManager == null){
				pathManager = new DinnerPathManager();
			}
		}
		return pathManager;
	}

	private DinnerPathManager(){
		resetRootPath();
	}
	...
	public String getRootPath() {
		if(rootPath == null){
			DLog.e("ECloudPathManager", "rootPath is null ");
		}
		return rootPath;
	}
	...
	public String getOtherCachePath(){
		return getMainPath()+"file/cache/other/";
	}
	...
	private void initDiretory() {
		...
		file = new File(getOtherCachePath());
		if (!file.exists()) {
			file.mkdirs();
		}
	}
